...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    public static int getFlagMasterResID(String code) {
        if (code == null)
            return 0;
	...
	public static int getFlagMasterResID(CCPCountry CCPCountry) {
        return getFlagMasterResID(CCPCountry.getNameCode());
