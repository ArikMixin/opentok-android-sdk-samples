...
public class ContactMultiListAdapter <CONTACT extends IContact> extends RecyclerView.Adapter  implements Filterable {
	...
	public ContactMultiListAdapter(Context context){
				...
				public void onItemClick(View view, int position) {
					...
					if (mContactSelectListener != null) {
						if (wrapper.isSelected)
							mContactSelectListener.onContactSelected((Contact) wrapper.contact);
						else
							mContactSelectListener.onContactUnSelected((Contact) wrapper.contact);
					}
	...
	public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
		if (holder.getItemViewType() == TYPE_MEMBER) {
			...
			if (contact.hasServerData()){
				...
				theHolder.mContactPicFlagCFIV.setContact(contact, item.isSelected, item.isCanceled);
			}
